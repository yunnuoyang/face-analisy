...
public class FaceEngineTest {
    ...
    public static void main(String[] args) {
        ...
        //从官网获取
        String appId = "BnBmMQG8NJ853v8h19SfSLR7nhaawuGbWF6JrC8zu4wD";
        String sdkKey = "G6mvKkaXFjx649qWefsXcVhtR6hKtzqHEPS13dDMXL9b";


        FaceEngine faceEngine = new FaceEngine("E:\\javaprojects\\face-analisy\\lib");
        //激活引擎
        ...
        //人脸检测2
        ImageInfo imageInfo2 = getRGBData(new File("d:\\ff.jpg"));
        ...
        //IR属性处理
        ImageInfo imageInfoGray = getGrayData(new File("d:\\aaa.jpg"));
